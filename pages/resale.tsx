...
const ResalePage = ({
    ...
    return (
        <Layout title="Для сдачи в аренду" description={`${title} - ${subtitle}`}>
            ...
            <Section linebreak>
                <h2 className="text-3xl md:text-4xl mb-4 text-black dark:text-white">Варианты</h2>
                <p className="my-2">
                    Купить <b>новостройку</b> для перепродажи с доходностью в 10-30% годовых
                  </p>
                <p className="my-2">
                    Купить квартиру <b>бизнес класса с дизайнерским ремонтом</b> для перепродажи с доходностью в 10-30% годовых
                </p>
            </Section>
